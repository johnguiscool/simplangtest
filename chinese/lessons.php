...
if(isset($_SESSION['username']))
{
	...
	if(empty($row))
	{
		...
		$login_message = "<a class = 'add-phrase-button' href='review.php?id=$dialogue_number&language=$language_to_check'>Add Dialogue $dialogue_number Phrases to Flashcards</a>";
	}
	else
	{
		$login_message = "<img src ='http://www.simplang.com/img/checkmark.png' > <span class = 'phrases-added-message'> Dialogue $dialogue_number phrases have been added to your flashcards. </span>";
	}
