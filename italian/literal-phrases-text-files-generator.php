...
for ($dialogue_number = 1; $dialogue_number <= 35; $dialogue_number++)
{
	...
	$french_path    =$texts_path."italianphrases".$dialogue_index.".txt";
...
function english_definition ($word)
	{
		...
		$sql = 
		"SELECT english FROM DICTIONARYitalian WHERE italian LIKE '".$word."' ;";
