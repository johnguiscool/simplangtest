...
$audio_path	 = "audio/dialogue-pt-".$dialogue_index;
$pics_path	 = "img/".$dialogue_index.".png";
$texts_path	 = $_SERVER['DOCUMENT_ROOT']."/portuguese/texts/";


$english_path      =$texts_path."englishphrases".$dialogue_index.".txt";
$french_path    =$texts_path."portuguesephrases".$dialogue_index.".txt";
